#! /usr/bin/python
#
#  Wepo core - Json Django cache backend
#
...
class MemcachedCacheJSON(MemcachedCache):
    ...
    def _cache(self):
        if getattr(self, '_client', None) is None:
            self._client = self._lib.Client(self._servers, pickler=Pickler, unpickler=Unpickler)
        return self._client
