		...
		***********************************************************/
		...
		if (!this.bu_icon) {
			...
			if (this.bu_icon == 'none') {
				this.bu_icon = '/assets/script/lib/jquery-smooth-zoom/zoom_assets/icons.png';
			}
			testOb.remove();
		}		
		...
		this.$image.hide();	
		this.imgList = [
			{loaded: false, src: this.bu_icon || '/assets/script/lib/jquery-smooth-zoom/zoom_assets/icons.png'}, //Icon image
			...
			if (delta > 0) {
				if (self.rA != self.zoom_max) {
					if (self.zoom_single){													
						...
						self.rA *= delta < 1 ? 1 + (.03 * delta) : 1.03;
						self.rA = self.rA > self.zoom_max ? self.zoom_max : self.rA;						
					}
					self._wheel = true;
					self.cFlag._zi = true;
